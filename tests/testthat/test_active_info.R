...
test_that("active_info checks parameters", {
  expect_error(active_info("series", k = 1,    b = 2,    local = !T))
  expect_error(active_info(NULL,     k = 1,    b = 2,    local = !T))
  expect_error(active_info(NA,       k = 1,    b = 2,    local = !T))
  expect_error(active_info("series", k = "k",  b = 2,    local = !T))
  expect_error(active_info("series", k = NULL, b = 2,    local = !T))
  expect_error(active_info("series", k = NA,   b = 2,    local = !T))
  expect_error(active_info("series", k = 0,    b = 2,    local = !T))
  expect_error(active_info("series", k = -1,   b = 2,    local = !T))
  expect_error(active_info("series", k = "k",  b = 0,    local = !T))
  expect_error(active_info("series", k = "k",  b = "b",  local = !T))
  expect_error(active_info("series", k = "k",  b = NULL, local = !T))
  expect_error(active_info("series", k = "k",  b = NA,   local = !T))
  expect_error(active_info("series", k = "k",  b = 2,    local = "TRUE"))
  expect_error(active_info("series", k = "k",  b = 2,    local = NULL))
  expect_error(active_info("series", k = "k",  b = 2,    local = NA))  
})

test_that("active_info on single series", {
  expect_equal(active_info(c(1, 1, 0, 0, 1, 0, 0, 1),
                           k = 2, b = 2, local = !T), 0.918296, tolerance = 1e-6)
  expect_equal(active_info(c(1, 0, 0, 0, 0, 0, 0, 0, 0),
                           k = 2, b = 2, local = !T), 0.000000, tolerance = 1e-6)
  expect_equal(active_info(c(0, 0, 1, 1, 1, 1, 0, 0, 0),
                           k = 2, b = 2, local = !T), 0.305958, tolerance = 1e-6)
  expect_equal(active_info(c(1, 0, 0, 0, 0, 0, 0, 1, 1),
                           k = 2, b = 2, local = !T), 0.347458, tolerance = 1e-6)
  expect_equal(active_info(c(3, 3, 3, 2, 1, 0, 0, 0, 1),
                           k = 2, b = 4, local = !T), 1.270942, tolerance = 1e-6)
  expect_equal(active_info(c(2, 2, 3, 3, 3, 3, 2, 1, 0),
                           k = 2, b = 4, local = !T), 1.270942, tolerance = 1e-6)
  expect_equal(active_info(c(2, 2, 2, 2, 2, 2, 1, 1, 1),
                           k = 2, b = 4, local = !T), 0.469566, tolerance = 1e-6)			   
})
...
test_that("active_info on ensamble of series", {
  ...
  expect_equal(active_info(series, k = 2, b = 2, local = !T), 0.459148, tolerance = 1e-6)
  ...
  expect_equal(active_info(series, k = 2, b = 2, local = !T),
  ...
  expect_equal(active_info(series, k = 2, b = 4, local = !T), 1.324292, tolerance = 1e-6)
})
...
test_that("active_info local on ensamble of series", {
  ...
  series[, 1] <- c(1, 1, 0, 0, 1, 0, 0, 1)
  series[, 2] <- c(0, 0, 0, 1, 0, 0, 0, 1)
  expect_equal(mean(active_info(series, k = 2, b = 2, local = T)),
  ...
  series[, 3] <- c(0, 0, 0, 0, 1, 1, 0, 0, 0)
  series[, 4] <- c(1, 1, 0, 0, 0, 1, 1, 2, 2)
  expect_equal(mean(active_info(series, k = 2, b = 4, local = T)),
