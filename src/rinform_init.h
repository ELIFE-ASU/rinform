...
extern void r_conditional_entropy_(int *xs, int *ys, int *n, int *bx, int *by, double *rval, int *err);
extern void r_local_conditional_entropy_(int *xs, int *ys, int *n, int *bx, int *by, double *rval, int *err);
...
extern void r_get_item_(int *histogram, int *size, int *counts, int *event, int *rval, int *err);
extern void r_set_item_(int *histogram, int *size, int *counts, int *event, int *value, int *err);
extern void r_resize_(int *histogram, int *size, int *counts, int *nhistogram, int *n, int *err);
extern void r_copy_(int *histogram, int *size, int *chistogram, int *csize, int *ccounts, int *err);
...
extern void r_accumulate_(int *histogram, int *size, int *counts, int *n, int *events, int *err);
...
extern void r_local_relative_entropy_(int *xs, int *ys, int *n, int *b, double *rval, int *err);
...
extern void r_shannon_mutual_info_(int *histogram_xy, int *size_xy, int *histogram_x, int *size_x, int *histogram_y, int *size_y, double *b, double *smi, int *err);
extern void r_shannon_conditional_entropy_(int *histogram_xy, int *size_xy, int *histogram_y, int *size_y, double *b, double *sce, int *err);
extern void r_shannon_cond_mutual_info_(int *histogram_xyz, int *size_xyz, int *histogram_xz, int *size_xz, int *histogram_yz, int *size_yz, int *histogram_z, int *size_z, double *b, double *scmi, int *err);
extern void r_shannon_relative_entropy_(int *histogram_p, int *size_p, int *histogram_q, int *size_q, double *b, double *sre, int *err);
extern void r_shannon_cross_entropy_(int *histogram_p, int *size_p, int *histogram_q, int *size_q, double *b, double *sce, int *err);
/* rinform_transfer_entropy.c */
extern void r_transfer_entropy_(int *ys, int *xs, int *n, int *m, int *b, int *k, double *rval, int *err);
extern void r_complete_transfer_entropy_(int *ys, int *xs, int *ws, int *l, int *n, int *m, int *b, int *k, double *rval, int *err);
extern void r_local_transfer_entropy_(int *ys, int *xs, int *n, int *m, int *b, int *k, double *rval, int *err);
extern void r_local_complete_transfer_entropy_(int *ys, int *xs, int *ws, int *l, int *n, int *m, int *b, int *k, double *rval, int *err);
